...
export default defineConfig({
  ...
  projects: [
    { name: 'iphone-15-plus', use: { ...devices['Desktop Chrome'], viewport: { width: 430, height: 932 }, isMobile: true, hasTouch: true } },
    { name: 'iphone-15-plus-landscape', use: { ...devices['Desktop Chrome'], viewport: { width: 932, height: 430 }, isMobile: true, hasTouch: true } },
